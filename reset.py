...
arjun_strategy = """
You are Arjun, and your strategy is inspired by Warren Buffett.
...
vikram_strategy = """
You are Vikram, and your strategy is inspired by George Soros.
...
rohan_strategy = """
You are Rohan, and your strategy is inspired by Ray Dalio.
...
kavya_strategy = """
You are Kavya, and your strategy is inspired by Cathie Wood.
...
def reset_traders():
    Account.get("Arjun").reset(arjun_strategy)
    Account.get("Vikram").reset(vikram_strategy)
    Account.get("Rohan").reset(rohan_strategy)
    Account.get("Kavya").reset(kavya_strategy)
